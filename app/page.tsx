  ...
  return (
    ...
    >
      ...
      <div className="text-left">
        <div className="text-[10px] uppercase font-bold text-white/80 leading-none">
          Download on the
        </div>
...
const AndroidButton = ({
  ...
  return (
    ...
    >
      ...
      <div className="text-left">
        <div className="text-[10px] uppercase font-bold text-slate-500 leading-none">
          Get it on
        </div>
      ...
      <div className="relative z-10">
        ...
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center">
            ...
            <div className="hidden md:flex items-center space-x-8">
              <a
                href="#features"
                className="text-slate-600 hover:text-rose-500 font-medium transition-colors"
              >
                Features
              </a>
              <a
            ...
            <div className="flex flex-col lg:flex-row gap-16">
              ...
              <div className="flex-1 text-center lg:text-left space-y-8 z-10">
                ...
                <p className="text-xl text-slate-500 max-w-xl mx-auto lg:mx-0 leading-relaxed font-medium">
                  The fastest way to clean up your iPhone or Android. Swipe left
                  to delete duplicates, swipe right to keep memories.
                </p>
            ...
            <div className="flex flex-col md:flex-row items-center gap-20">
              ...
              <div className="flex-1 order-1 md:order-2 space-y-6">
                ...
                <h2 className="text-4xl font-bold text-slate-900">
                  Don&apos;t organize everything at once.
                </h2>
                <p className="text-lg text-slate-600 leading-relaxed">
                  Cleaning 5,000 photos is overwhelming. <br />
                  Our <strong>Calendar View</strong> lets you tackle one month
                  at a time. Pick &quot;August&quot;, swipe for 5 minutes, and
                  feel the satisfaction of a clean month.
                </p>
        ...
        <section id="features" className="py-24 bg-white overflow-hidden">
          <div className="max-w-7xl mx-auto px-4 text-center mb-16">
            <span className="text-rose-500 font-bold tracking-wider uppercase text-sm">
              The Game Changer
            </span>
            ...
            <p className="text-slate-500 max-w-2xl mx-auto text-lg">
              It&apos;s as easy as a dating app. We show you the photo, you
              decide its fate.
            </p>
          </div>
          ...
          <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row items-center justify-center gap-12 relative">
            <div className="hidden md:block text-right space-y-2 translate-y-12">
              ...
              <p className="text-slate-500 text-sm w-48 ml-auto">
                Blurry pics, duplicates, and screenshots go here.
              </p>
            ...
            <div className="hidden md:block text-left space-y-2 translate-y-12">
              ...
              <p className="text-slate-500 text-sm w-48">
                Only your absolute best memories stay.
              </p>
            ...
            <div className="flex flex-col md:flex-row items-center gap-20">
              <div className="flex-1 space-y-8 relative z-10">
                ...
                <p className="text-xl text-slate-300 leading-relaxed">
                  Before deleting, review your trash. One tap on &quot;Empty
                  Trash&quot; and boom—you just saved 2GB of space. Your phone
                  will run faster.
                </p>
        ...
        <footer className="bg-white border-t border-slate-100 py-12">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center md:text-left flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <div className="flex gap-8 text-slate-500 text-sm font-medium">
              <a
                href="https://qodam.com/privacy"
                className="hover:text-rose-500 transition-colors"
              >
                Privacy Policy
              </a>
              <a
                href="https://qodam.com/terms"
                className="hover:text-rose-500 transition-colors"
              >
                Terms of Use
              </a>
              <a
                href="mailto:codinghubstudio@gmail.com"
                className="hover:text-rose-500 transition-colors"
              >
                Support &amp; Contact
              </a>
            ...
            <div className="text-slate-400 text-sm">
              © {new Date().getFullYear()} QODAM. All rights reserved.
            </div>
          </div>
        </footer>
      </div>
